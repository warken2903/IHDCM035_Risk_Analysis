...
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Scénario de Menace\end{tabular}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Source de la Menace\end{tabular}}} & \textbf{Probabilité} \\ \hline
\endfirsthead
%
\endhead
%
\begin{tabular}[c]{@{}c@{}}Panne de serveur\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Dégradation naturelle des compo-\\ sants du serveur\\ - Manipulation d'un technicien\\ - Personne mal-intentionnée\end{tabular} & Haute \\ \hline

\begin{tabular}[c]{@{}c@{}}Incendie dans la\\salle des serveur\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Dysfonctionnement matériel\\ - Surtension électrique\\ - Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline

\begin{tabular}[c]{@{}c@{}}Infection par un\\ virus informatique\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Téléchargement de données non-\\ vérifiées sur Internet\\ - Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline

\begin{tabular}[c]{@{}c@{}}Récupération de données\\confidentielles\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Administrateur système\\ - Administrateur système third-party\\ - Personne mal-intentionnée\end{tabular} & Haute \\ \hline
...
\endhead
%
Panne de serveur & \begin{tabular}[c]{@{}l@{}}- Dégradation naturelle des compo-\\ sants du serveur\\ - Manipulation d'un technicien\\ - Personne mal-intentionnée\end{tabular} & Haute \\ \hline

\begin{tabular}[c]{@{}c@{}}Incendie dans\\ la salle des \\ serveur\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Dysfonctionnement matériel\\ - Surtension électrique\\ - Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline

\begin{tabular}[c]{@{}c@{}}Infection par un\\ virus informatique\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Téléchargement de données non-\\ vérifiées sur Internet\\ - Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline

\begin{tabular}[c]{@{}c@{}}Récupération des données\\ de connexion\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Administrateur système\\ - Administrateur système third-party\\ - Personne mal-intentionnée\end{tabular} & Haute \\ \hline
...
\endhead
%
Panne d'ordinateur & \begin{tabular}[c]{@{}l@{}}- Dégradation naturelle des compo-\\ sants du serveur\\ - Manipulation d'un technicien\\ - Personne mal-intentionnée\end{tabular} & Haute \\ \hline
Panne de courant électrique & \begin{tabular}[c]{@{}l@{}}- Condition météorologique\\ - Technicien qui débranche un câble\\ par erreur\\ - Problème sur le réseau électrique\\ - Personne mal-intentionnée\end{tabular} & Haute \\ \hline
\begin{tabular}[c]{@{}c@{}}Infection par un virus\\ informatique\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Téléchargement de données non-\\ vérifiées sur Internet\\ - Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline
...
\endhead
%
Incendie & \begin{tabular}[c]{@{}l@{}}- Surchauffe de composants\\ - Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline
\begin{tabular}[c]{@{}c@{}}Corruption des données\end{tabular} & - Erreur du matériel & Moyenne \\ \hline
\begin{tabular}[c]{@{}c@{}}Suppression des données\end{tabular} & \begin{tabular}[c]{@{}l@{}}- Administrateur système \\- Personne mal-intentionnée\end{tabular} & Moyenne \\ \hline
